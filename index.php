    ...
    <div id="wrapper">
        <div id="container">
            <div id="welcome">
                <h1><span>Welcome to</span> PHP Builder by <code>fouka@nadir.ovh </code></h1>
            </div>
...
Available commands:<br/>
  ...
  load_data  Loading all data from database Mysql LAMP<br/>
  update     Updates your dependencies to the latest version according to composer.json, and updates the composer.lock file.<br/>
